...
$(call inherit-product-if-exists, vendor/vernee/k11tc_a/k11tc_a-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/vernee/k11tc_a/overlay
PRODUCT_PACKAGE_OVERLAYS += device/vernee/k11tc_a/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/vernee/k11tc_a
...
PRODUCT_PROPERTY_OVERRIDES += \
  ...
  ro.romstats.version=14.2_64_bit \
